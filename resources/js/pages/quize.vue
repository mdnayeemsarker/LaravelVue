...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <router-link class="breadcrumb-item" :to="{ name: 'Dashboard' }">Dashboard</router-link>
                        <li class="breadcrumb-item active">Quize</li>
                        <!-- <router-link class="breadcrumb-item" :to="{ name: 'AddQuize' }">Create Quize</router-link> -->
                        <button @click="showModal = true" class="breadcrumb-item">Add Quiz</button>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="modal-lg" v-show="showModal">
